...
do
    ...
    do
        ...
        # Extract the .pkl file and save the results in .json files
        python results_explore_fewshot.py \
            --results_dir llm-transparency-tool-bak/YOUR_RESULTS_DIR \
            --relations $relation \
            --languages $lang
            
        # Step 2 - Plot rank curves for each factual instance
        python plot_scripts/rank_plot.py \
            --results_dir llm-transparency-tool-bak/YOUR_RESULTS_DIR \
            --relation $relation \
            --languages $lang \
            --y_type rank
